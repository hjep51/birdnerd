...
public class MainLayout extends AppLayout {
  ...
  private void addDrawerContent() {
    Span appName = new Span("Bird Nerd");
  ...
  private SideNav createNavigation() {
    ...
    nav.addItem(
        new SideNavItem(
            "Species list", SpecieslistView.class, LineAwesomeIcon.TH_LIST_SOLID.create()));
    nav.addItem(new SideNavItem("Tags", TagsView.class, LineAwesomeIcon.HASHTAG_SOLID.create()));
    nav.addItem(
        new SideNavItem(
            "BN Workflow", BNWorkflowView.class, LineAwesomeIcon.PENCIL_RULER_SOLID.create()));
    nav.addItem(
        new SideNavItem(
            "Dofbasen", DofbasenView.class, LineAwesomeIcon.BROADCAST_TOWER_SOLID.create()));
