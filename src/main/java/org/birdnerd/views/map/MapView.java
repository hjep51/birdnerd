...
public class MapView extends Main implements HasComponents, HasStyle {
  ...
  public MapView() {
    ...
    // Create the registry which is needed so that components can be reused and their methods
    // invoked
    // Note: You normally don't need to invoke any methods of the registry and just hand it over to
    // the components
