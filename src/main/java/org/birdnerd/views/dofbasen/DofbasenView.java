...
@PageTitle("Dofbasen")
@Route(value = "dofbasen", layout = MainLayout.class)
@Uses(Icon.class)
public class DofbasenView extends Div {
  ...
  public DofbasenView(SamplePersonService SamplePersonService) {
    this.samplePersonService = SamplePersonService;
    setSizeFull();
    addClassNames("dofbasen-view");
  ...
  public static class Filters extends Div implements Specification<SamplePerson> {
    ...
    public Predicate toPredicate(
        Root<SamplePerson> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
      ...
      if (!name.isEmpty()) {
        ...
        Predicate firstNameMatch =
            criteriaBuilder.like(
                criteriaBuilder.lower(root.get("firstName")), lowerCaseFilter + "%");
        Predicate lastNameMatch =
            criteriaBuilder.like(
                criteriaBuilder.lower(root.get("lastName")), lowerCaseFilter + "%");
      ...
      if (!phone.isEmpty()) {
        ...
        Predicate phoneMatch =
            criteriaBuilder.like(
                ignoreCharacters(
                    ignore, criteriaBuilder, criteriaBuilder.lower(root.get(databaseColumn))),
                "%" + lowerCaseFilter + "%");
      ...
      if (!roles.isEmpty()) {
        ...
        for (String role : roles.getValue()) {
          rolePredicates.add(
              criteriaBuilder.equal(criteriaBuilder.literal(role), root.get(databaseColumn)));
        }
